...
Runtime C ABI crate of [bffi-rs](https://github.com/z2net/bffi-rs/blob/main/README.md) - the Bun-only
...
design in [docs/DESIGN.md](https://github.com/z2net/bffi-rs/blob/main/docs/DESIGN.md)
...
[CALLING-CONVENTION.md](https://github.com/z2net/bffi-rs/blob/main/crates/bffi-build/CALLING-CONVENTION.md).
...
- Free exports return the [`ErrorCode`](https://github.com/z2net/bffi-rs/blob/main/crates/bffi-core)
...
The renderer is pure and lives in [`bffi-dts`](https://github.com/z2net/bffi-rs/blob/main/crates/bffi-dts)
