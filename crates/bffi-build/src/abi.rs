...
//! crate, not here - into the ten `extern "C"` symbols JavaScript
...
macro_rules! bffi_runtime_abi {
    () => {
        ...
        pub extern "C" fn bffi_error_cause_ptr(handle: u64) -> *const u8 {
            #[cfg(debug_assertions)]
            {
                $crate::runtime::error_cause_ptr(::bffi_core::Handle::from_raw(handle))
            }
            #[cfg(not(debug_assertions))]
            {
                ::bffi_core::boundary::run_extern_body_or(
        ...
        pub extern "C" fn bffi_error_cause_len(handle: u64) -> u64 {
            #[cfg(debug_assertions)]
            {
                $crate::runtime::error_cause_len(::bffi_core::Handle::from_raw(handle))
            }
            #[cfg(not(debug_assertions))]
            {
                ::bffi_core::boundary::run_extern_body_or(
