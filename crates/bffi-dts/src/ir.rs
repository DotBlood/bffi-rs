...
//! `#[bffi]` macro (a later stage) can emit them as constants and the
//! renderer can consume them without allocation.
...
/// A named module grouping the native functions it exports.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
