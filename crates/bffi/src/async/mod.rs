...
//!
//! ```
//! use bffi::bffi_async::{spawn, AsyncValue};
...
//!     type Output = Result<AsyncValue, bffi::core::BffiError>;
...
//! assert!(bffi::bffi_async::cancel(task));
//! assert_eq!(bffi::bffi_async::pending_tasks(), 0);
//! ```
