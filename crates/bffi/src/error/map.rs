...
use super::js_error::{JsErrorName, JsErrorShape};
...
///
/// Returns `None` when no error is stored; like [`bffi::core::take_last_error`]
...
mod tests {
    use super::*;
    use crate::bffi_error::js_error::JsErrorName;
