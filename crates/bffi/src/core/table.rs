...
//!   ([`super::hazard`]), re-validate the pair, then take an owned
...
//! threads; tables stored in the process-wide [`super::catalog::Registry`]
...
use super::handle::{Handle, MAX_GENERATION, MAX_INDEX, TypeTag};
use super::hazard;
use std::fmt;
